        ...
        <div className="relative flex flex-col items-center justify-center min-h-screen bg-background text-primary-foreground overflow-hidden p-8">
            <div className="absolute inset-0 z-0">
                <Image
                    ...
                    data-ai-hint={
                        takeawayPlaceholder?.imageHint ?? "takeaway bags"
                    }
                    priority
                    unoptimized={false}
                />
                <div className="absolute inset-0 bg-background/60 backdrop-blur-[3px]"></div>
            </div>
            ...
            <div className="relative z-10 text-center flex flex-col items-center">
                ...
                >
                    The amazing journey to delicious <span className='text-primary font-bold uppercase'>tendies</span> is just a few
                    clicks away. Get ready!
                </p>

                <div className="flex flex-col sm:flex-row items-center gap-6 mt-6">
                    <div className="flex items-center gap-5">
                        <Link
                            href="https://gofood.link/a/Q9vkRR7"
                            target="_blank"
                        ...
                        <Link
                            href="https://r.grab.com/g/6-0ABEA09D71BF4051BA2D692FA67DEB22_MEXMPS-6-C7DTJ4DZDELHBA"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            <Image
                ...
                <div className="flex flex-col sm:flex-row items-center mt-10">
                    <Button
                        ...
                        variant="outline"
                        size="lg"
                        className="bg-transparent text-foreground border-2 border-current font-bold text-lg px-8 py-6 rounded-full hover:bg-foreground hover:text-background"
                    >
                        <Link href="/#about">
